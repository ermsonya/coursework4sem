...
{
    public partial class Add_structure3 : Form
    {
        public Add_structure3()
        {
            InitializeComponent();
        }
        ...
        private void add_structure()
        {
            ...
            Query = $"SELECT id_action FROM actions WHERE name_action = ('{comboBox3.SelectedItem.ToString()}')";
            command = new SqlCommand(Query, dataBase.GetConnection());
            reader = command.ExecuteReader();
            reader.Read();
            var id_action3 = reader.GetValue(0);
            reader.Close();
            ...
            addQuery = $"INSERT INTO structure (id_nomination, number, id_action) values ('{id_nomination}', 3, '{id_action3}')";
            command = new SqlCommand(addQuery, dataBase.GetConnection());
            number = command.ExecuteNonQuery();
        ...
        private void Add_structure3_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                if ((comboBox1.SelectedItem == comboBox2.SelectedItem) || (comboBox2.SelectedItem == comboBox3.SelectedItem) || (comboBox1.SelectedItem == comboBox3.SelectedItem))
        ...
        private void Add_structure3_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
